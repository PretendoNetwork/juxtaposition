...
function DefaultHead(props: DefaultHeadProps): ReactNode {
	...
	return (
		<>
			<link rel="stylesheet" type="text/css" href={assetUrl('/assets/ctr/css/juxt.css')} />
			{/* Debug allows non-console browsers to have some amount of the cave API. */}
			{addDebugJs ? <script src={assetUrl('/assets/ctr/js/debug.global.js')}></script> : null}
			...
			{loadJs ? <script src={assetUrl('/assets/ctr/js/juxt.global.js')}></script> : null}
		</>
	);
}
